...
export function ProfileDangerZone({ handleDeactivateAccount }: ProfileDangerZoneProps) {
  return (
    <Card className="group rounded-none border border-red-200 dark:border-red-950/80 bg-background shadow-sm hover:border-red-500/50 transition-all duration-300">
      ...
      <CardContent className="p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 font-mono text-xs">
        ...
        <AlertDialog>
          <AlertDialogTrigger className="rounded-none border-red-200 hover:border-red-500/50 hover:bg-red-50 dark:hover:bg-red-950/20 text-red-600 hover:text-red-700 h-9 font-semibold transition-all duration-300 cursor-pointer border px-3 py-1 flex items-center justify-center text-xs">
          ...
          <AlertDialogContent className="font-mono text-xs">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This action cannot be undone. This will permanently deactivate your user account and erase your settings and data.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
