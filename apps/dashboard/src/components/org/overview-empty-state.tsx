...
export function OverviewEmptyState({ orgName, orgSlug, onShowMockData }: OverviewEmptyStateProps) {
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 rounded-none flex flex-col gap-6 w-full">
