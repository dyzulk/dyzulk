...
export default function ErrorPage({
  ...
  return (
    <div className="relative flex min-h-[75vh] flex-col items-center justify-center overflow-hidden px-6 py-12 text-center rounded-none">
      ...
      {/* Error Card / Frame - strictly rounded-none */}
      <div className="flex flex-col items-center max-w-md w-full p-8 border border-destructive/20 bg-card/30 backdrop-blur-md rounded-none shadow-sm">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3 w-full rounded-none">
          <button
            ...
            className={cn(
              ...
              "w-full sm:w-auto font-medium cursor-pointer rounded-none"
            )}
          >
