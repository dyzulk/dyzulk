        ...
        <nav className="hidden md:flex items-center gap-1 text-sm font-medium">
          <NavigationMenu className="z-50">
            <NavigationMenuList className="gap-1">
              {/* Product */}
              <NavigationMenuItem>
                <NavigationMenuTrigger className="px-3.5 py-2 h-auto text-sm text-muted-foreground hover:text-foreground hover:bg-accent/60 bg-transparent transition-colors font-medium rounded-none">
                  Product
                </NavigationMenuTrigger>
              ...
              <NavigationMenuItem>
                <Link
                  href={PATHS.pricing}
                  className="px-3.5 py-2 inline-flex items-center text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-accent/60 transition-colors rounded-none"
                >
                  Pricing
                </Link>
              </NavigationMenuItem>
