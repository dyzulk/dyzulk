...
| **Paths & Module Namespaces** | Use standard Git-relative paths (`./...`, `../...`) for markdown links, and declared module namespaces (`@workspace/ui/...`, `@dyzulk/...`, `@/...`) for code imports. | **DO NOT write machine-specific absolute paths** (`file:///...`, `/home/...`, `C:\...`, `/Users/...`) in documentation or source code. |
